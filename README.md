...
[LayeredLayouts](https://github.com/oxinabox/LayeredLayouts.jl) for the Zarate algorithm, which is a more expensive algorithm (but potentially produces better layouts), and [NetworkLayout](https://github.com/JuliaGraphs/NetworkLayout.jl) for other layout algorithms.
